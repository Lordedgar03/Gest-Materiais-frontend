...
const TEMPLATE_TO_PERMS = {
  ...
  baseline: [{ module: "ajuda", action: "visualizar" }],
  ...
  // NOVO: módulo de almoço/refeitório
  manage_lunch: [
    { module: "aluno", action: "visualizar" },
    ...
    // se quiseres que veja relatórios de almoço
    ...
    () => [
      {
        ...
        items: [
          // Dashboard (admin-only). Será filtrado pelo hasPermission.
          {
            ...
            label: "Dashboard",
            perm: { module: "dashboard", action: "visualizar" },
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            icon: List,
            label: "Categorias",
            perm: { module: "categorias", action: "visualizar" },
          },
          {
            path: "/tipos",
            icon: Boxes,
            label: "Tipos",
            perm: { module: "tipos", action: "visualizar" },
          },
          {
            path: "/materiais",
            icon: PackageCheck,
            label: "Materiais",
            perm: { module: "materiais", action: "visualizar" },
          },
          {
            path: "/movimentos",
            icon: Repeat,
            label: "Movimentações",
            perm: { module: "movimentacoes", action: "visualizar" },
          },
          {
            path: "/requisicoes",
            icon: FileText,
            label: "Requisições",
            perm: { module: "requisicoes", action: "visualizar" },
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            icon: FileText,
            label: "Vendas",
            perm: { module: "venda", action: "visualizar" },
          },
          {
            path: "/caixa",
            icon: Receipt,
            ...
            perm: { module: "venda", action: "visualizar" },
          }, // NOVOS: Alunos e Almoços (usam módulos "aluno" e "almoco")
          {
            path: "/alunos",
            icon: Users,
            label: "Alunos",
            perm: { module: "aluno", action: "visualizar" },
          },
          {
            path: "/almoco",
            icon: Receipt,
            label: "Almoços",
            perm: { module: "almoco", action: "visualizar" },
          },
          /* {
            path: "/pdv",
            icon: Receipt,
        ...
        items: [
          {
            ...
            icon: Users,
            label: "Utilizadores",
            perm: { module: "utilizador", action: "visualizar" },
          },
          {
            path: "/materials-recycle",
            icon: Recycle,
            label: "Reciclagem",
            perm: { module: "materiais", action: "eliminar" },
          },
        ],
      },
      {
        ...
        items: [
          /* // Ambos admin-only
          {
            ...
            icon: FileText,
            label: "Relatórios",
            perm: { module: "relatorios", action: "visualizar" },
          },
          se tiver /recibos, troque o path
          {
            ...
            icon: Receipt,
            label: "Recibos",
            perm: { module: "recibo", action: "visualizar" },
          },
          // Ajuda (baseline)*/
          {
            path: "/ajuda",
            icon: BadgeInfo,
            label: "Ajuda",
            perm: { module: "ajuda", action: "visualizar" },
          },
        ],
      },
    ],
  ...
  const filteredGroups = useMemo(() => {
    const groups = menuGroups.map((g) => ({
      ...
      items: g.items.filter((it) =>
        hasPermission(permsIndex, roles, it.perm.module, it.perm.action)
      ),
    }));
