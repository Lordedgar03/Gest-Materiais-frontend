  ...
  return (
    ...
    >
      <p className="text-sm text-slate-700">
        ...
        <span className="font-semibold">{itemName}</span>? Esta ação não pode
        ser desfeita.
      </p>
    </Modal>
  );
...
export default function CategoriesPage() {
  ...
  // Reset para página 1 apenas quando o debounced mudar
  useEffect(() => {
    setCurrentPage(1);
        ...
        <CardHeader
          ...
          subtitle={
            isAdmin
              ...
              : `Você tem acesso a ${allowedCategoryIds.length} categoria${
            ...
            <div className="flex items-center gap-2">
              {isAdmin ? (
                ...
                <div className="flex items-center gap-2 px-3 py-1 bg-emerald-100 text-emerald-800 rounded-full text-sm font-medium">
                  ...
                  {allowedCategoryIds.length} Categoria
                  {allowedCategoryIds.length !== 1 ? "s" : ""}
                </div>
              )}
