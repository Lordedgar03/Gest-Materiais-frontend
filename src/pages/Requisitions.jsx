  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div
          className={`w-full ${maxWidth} rounded-2xl bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl shadow-2xl border border-white/20 dark:border-gray-600/50`}
        >
          ...
          {footer && (
            <div className="p-6 border-t border-gray-200/50 dark:border-gray-600/50">
              {footer}
            </div>
          )}
        </div>
...
function StatusChip({ status }) {
  const baseColors = {
    Pendente:
      "bg-gradient-to-r from-yellow-100 to-amber-100 dark:from-yellow-800/80 dark:to-amber-800/80 text-yellow-800 dark:text-yellow-100 border-yellow-200 dark:border-yellow-600/50",
    Aprovada:
      "bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-800/80 dark:to-emerald-800/80 text-green-800 dark:text-green-100 border-green-200 dark:border-green-600/50",
    Rejeitada:
      "bg-gradient-to-r from-red-100 to-rose-100 dark:from-red-800/80 dark:to-rose-800/80 text-red-800 dark:text-red-100 border-red-200 dark:border-red-600/50",
    Cancelada:
      "bg-gradient-to-r from-gray-100 to-slate-100 dark:from-gray-700/80 dark:to-slate-700/80 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-500/50",
    Parcial:
      "bg-gradient-to-r from-blue-100 to-sky-100 dark:from-blue-800/80 dark:to-sky-800/80 text-blue-800 dark:text-blue-100 border-blue-200 dark:border-blue-600/50",
    "Em Uso":
      "bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-800/80 dark:to-purple-800/80 text-indigo-800 dark:text-indigo-100 border-indigo-200 dark:border-indigo-600/50",
    Atendida:
      "bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-800/80 dark:to-teal-800/80 text-emerald-800 dark:text-emerald-100 border-emerald-200 dark:border-emerald-600/50",
    Devolvida:
      "bg-gradient-to-r from-teal-100 to-cyan-100 dark:from-teal-800/80 dark:to-cyan-800/80 text-teal-800 dark:text-teal-100 border-teal-200 dark:border-teal-600/50",
  };

  const cls =
    baseColors[status] ||
    "bg-gray-100 dark:bg-gray-700/80 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-500/50";
  return (
    <span
      className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${cls} shadow-sm`}
...
function ReqCard({
  ...
  if (firstItem) {
    restante =
      Number(firstItem.rqi_quantidade || 0) -
      Number(firstItem.rqi_qtd_atendida || 0);
    emUso =
      Number(firstItem.rqi_qtd_atendida || 0) -
      Number(firstItem.rqi_qtd_devolvida || 0);
  }

  const canApprove =
    isAdmin && !isRejectedOrCanceled && statusAllowsApproveFlow && mayDecide;
  const canReject =
    isAdmin && !isRejectedOrCanceled && statusAllowsApproveFlow && mayDecide;
  const canCancel =
    !isRejectedOrCanceled && statusAllowsApproveFlow && mayDecide;
  ...
  const actions = [
    ...
    },
    {
      ...
      style:
        "bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-500 shadow-sm",
      show: canDeleteBtn,
    },
  ].filter((a) => a.show);
        ...
        <div className="p-6 border-t border-gray-200/50 dark:border-gray-600/50 bg-gray-50/50 dark:bg-gray-700/50">
          ...
          <div className="flex sm:hidden gap-2">
            {primaryMobile && (
              ...
              >
                <primaryMobile.icon size={14} aria-hidden />{" "}
                {primaryMobile.label}
              </button>
            )}
            {restMobile.length > 0 && (
              <div className="relative">
                ...
                {moreOpen && (
                  <div
                    role="menu"
                    className="absolute right-0 mt-2 min-w-[12rem] rounded-xl border border-gray-200 dark:border-gray-600 bg-white/95 dark:bg-gray-700/95 backdrop-blur-xl shadow-xl z-10 p-2"
                  >
                    {restMobile.map((a) => {
                      const Icon = a.icon;
                      return (
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20">
      <div className="h-full flex flex-col">
        {/* Header */}
        <div className="sticky top-0 z-30 bg-white/90 dark:bg-gray-800 backdrop-blur-xl border-b border-black dark:border-gray-600/50 shadow-lg">
          <div className="mx-auto">
            ...
            {error && (
              <div
                role="alert"
                className="mx-6 mb-6 rounded-xl bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 border border-red-200 dark:border-red-700/50 p-4"
              >
            ...
            <section className="px-6 pb-6">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                <div className="lg:col-span-5">
                  <label
                    htmlFor="busca-req"
                    className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2  items-center gap-2"
                  >
              ...
              <>
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <span>
                      {list.length} requisição{list.length !== 1 ? "ões" : ""}{" "}
        ...
        footer={
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
            <button
              ...
              className="px-6 py-3 border border-gray-900 bg-amber-100 dark:border-gray-500 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 transition-colors font-medium"
            >
              Cancelar
            </button>
            <button
      ...
      >
        <form id="form-req" onSubmit={submitRequisicao} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2  items-center gap-2">
        ...
        footer={
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
            ...
            <button
              onClick={() => {
                const motivo =
                  document.getElementById("motivo-dec")?.value || "";
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-700/50">
            <p className="text-sm text-blue-800 dark:text-blue-200">
              <span className="font-semibold">
                Quantidade restante para atender:
              </span>{" "}
              {uiModal.payload?.restante ?? 0}
            </p>
          </div>
          <div>
            <label
        ...
        footer={
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
            ...
            <button
              onClick={() => {
                const quantidade = Number(
                  document.getElementById("qtd-dev")?.value || 0
                );
                const condicao =
                  document.getElementById("cond-dev")?.value || "Boa";
        ...
        <div className="space-y-4">
          <div className="p-4 bg-teal-50 dark:bg-teal-900/30 rounded-xl border border-teal-200 dark:border-teal-700/50">
            <p className="text-sm text-teal-800 dark:text-teal-200">
              <span className="font-semibold">Quantidade em uso:</span>{" "}
              {uiModal.payload?.emUso ?? 0}
            </p>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                  Esta ação não poderá ser desfeita. Todos os dados relacionados
                  a esta requisição serão permanentemente removidos.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="font-medium text-gray-900 dark:text-white">
                  {solicitanteNome(viewReq) ||
                    (solicitanteId(viewReq)
                      ? `Usuário #${solicitanteId(viewReq)}`
                      : "—")}
                </div>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-right text-xs font-semibold text-gray-600 dark:text-gray-200 uppercase tracking-wider">
                        Ações
                      </th>
                    </tr>
                  </thead>
                    ...
                    {(viewReq.itens ?? []).map((it, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-sm font-semibold text-green-700 dark:text-green-300">
                            {atendido}
                          </td>
                          <td className="px-6 py-4 text-sm font-semibold text-purple-700 dark:text-purple-300">
                            {devolvido}
                          </td>
                          <td className="px-6 py-4">
