  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Glow */}
        <div className="absolute -top-24 -left-24 size-125 rounded-full blur-3xl bg-indigo-600/20" />
        <div className="absolute -bottom-24 -right-24 size-125 rounded-full blur-3xl bg-blue-500/20" />
