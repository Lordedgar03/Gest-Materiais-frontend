              ...
              <table className="w-full text-sm">
                ...
                <thead className="bg-indigo-300/20 ">
                  <tr>
                    ...
                    <Th onClick={() => handleSort("mov_preco")} active={sortField === "mov_preco"} dir={sortDirection}>Preço (STN)</Th>
                ...
                <tbody>
                  {pageSlice.map((mov, idx) => (
                    ...
                    >
                      ...
                      <td className="p-2">STN {Number(mov.mov_preco).toFixed(2)}</td>
                      <td className="p-2">
        ...
        {!detail ? null : (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <InfoRow label="Preço unitário (STN)" value={`STN ${Number(detail.mov_preco).toFixed(2)}`} />
              <InfoRow label="Total (STN)" value={`STN ${(Number(detail.mov_preco) * Number(detail.mov_quantidade || 0)).toFixed(2)}`} />
              <InfoRow
                label="Data"
